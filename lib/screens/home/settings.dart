      ...
      children: [
        Container(
          ...
          child: Column(
            ...
            children: [
            Text(mockUserData[0]["name"], // 임시 텍스트, 나중에 받아온 유저 정보를 렌더링하는 것으로 변경
              ...
              Row(
                ...
                children: [
                  SizedBox(
                    ...
                    child: const Divider(thickness: 0.5, color: Colors.white), // 구분선
                  ),
                ],
              ),
            Text(
                DateFormat('yyyy/MM/dd').format(DateTime.parse(mockUserData[0]["birthday"])), // 나중에 유저 정보의 생년월일로 변경
                style: const TextStyle(
                fontSize: 16,
                color:Colors.white,
                )),
            Text(mockUserData[0]["email"], // 임시 텍스트, 나중에 받아온 유저 정보를 렌더링하는 것으로 변경
              style: const TextStyle(
                fontSize: 16,
                color:Colors.white,
                )),
            Text(mockUserData[0]["country"], // 임시 텍스트, 나중에 받아온 유저 정보를 렌더링하는 것으로 변경
              style: const TextStyle(
                fontSize: 16,
                color:Colors.white,
                )),
        ...
        const Text("My Information", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
        Container(
          width: screenWidth * 0.85,
          height: screenHeight * 0.2,
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(20),
            boxShadow: const [
              BoxShadow(color: Color.fromRGBO(0, 0, 0, 0.3), spreadRadius: 0.1, blurRadius: 3, offset: Offset(0, 3)),
            ],
          ),
          child: Column(
            ...
            children: [
              GestureDetector(
                onTap: () => ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text("관심사 설정")), // 백엔드에서 데이터 가져오는 작업으로 수정 필요
                ),
                child: Container(
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      SizedBox(width: screenWidth * 0.03),
                      const Icon(Icons.sentiment_very_satisfied, size: 20, color: Colors.grey),
                      SizedBox(width: screenWidth * 0.03),
                      const Text("Health Condition", style: TextStyle(fontSize: 14)),
                      Expanded(child: Container()), 
                      Padding(
                        padding: EdgeInsets.only(right: screenWidth * 0.05),
                        child: const Icon(Icons.arrow_forward_ios, size: 16, color: Colors.grey),
              ...
              Row(
                ...
                children: [
                  SizedBox(
                    width: screenWidth * 0.8,
                    child: const Divider(thickness: 0.5, color: Colors.grey), // 구분선
                  ),
                ],
              ),
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      SizedBox(width: screenWidth * 0.03),
                      const Text("Birth Method", style: TextStyle(fontSize: 14)),
                      Expanded(child: Container()), 
                      Padding(
                        padding: EdgeInsets.only(right: screenWidth * 0.05),
                        child: const Icon(Icons.arrow_forward_ios, size: 16, color: Colors.grey),
                  ...
                  child: Column(
                    ...
                    children: [
                      GestureDetector(
                        ...
                        onTap: () {
                          provider.toggleAll(!provider.allNotificationsEnabled);
                        },
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                      ...
                      GestureDetector(
                        behavior: HitTestBehavior.translucent,
                        onTap: () {
                          provider.toggleMorningCheckIn(!provider.morningCheckInEnabled);
                        },
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            ...
                            Transform.scale(
                              ...
                              child: Switch(
                                ...
                                onChanged: (value) {
                                  provider.toggleMorningCheckIn(value);
                                },
                                activeColor: const Color(0xFFbec5a4),
                              ),
                            ),
                      ...
                      GestureDetector(
                        behavior: HitTestBehavior.translucent,
                        onTap: () {
                          provider.toggleGoalReminders(!provider.goalRemindersEnabled);
                        },
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
