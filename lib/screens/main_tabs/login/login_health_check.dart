...
class _LoginHealthCheckState extends State<LoginHealthCheck> {
  final List<List<String>> healthRows = [
    ...
    ['모유 수유가 힘들어요', '붓기가 있어요', '식욕이 없어요', '소화가 안돼요'],
    ['우울해요', '불안해요', '자주 눈물이 나요', '예민해졌어요'],
    ['외로워요', '공허해요', '짜증이 많아졌어요', '무기력해요'],
    ['집중이 잘 안돼요', '생각이 너무 많아요', '자신감이 없어요', '내 자신이 낯설어요'],
    ['괜찮아요', '조금은 여유로워요', '기분이 안정돼요', '버틸 수 있어요'],
  ];
